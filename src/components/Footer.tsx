    ...
    return (
        <ThemeProvider theme={theme}>
            <Stack width={"100%"} justifyContent={"center"} justifyItems={"center"}>
                <Stack display={"flex"} direction={{ xs: "column", lg: "row" }} width={"100%"} bgcolor='secondary.main' flexGrow={0} justifyContent={"center"} alignItems={"center"}>
                    <Stack p={2} flexDirection={"column"} textAlign='left' width={{ xs: "100%", lg: (1 / 3) }} margin={{ xs: 0, lg: 5 }} justifyContent={"center"} alignItems={"center"}>
                        ...
                        <Box padding={2}>
                            ...
                            <Typography variant='body1' color='text.secondary' pl={1}>
                    ...
                    <Divider orientation='vertical' flexItem sx={{ my: 5, bgcolor: "#F1F1F1FF" }} />
                    <Stack p={2} textAlign='left' width={{ xs: "100%", lg: (1 / 3) }} margin={{ xs: 0, lg: 5 }} spacing={2} justifyContent={"center"} justifyItems={"center"}>
                        ...
                        <Typography variant='body1' color='text.secondary' maxWidth={"450px"}>
                            ...
                            このサイトを利用することで生じたいかなる損害についても、運営元は一切の責任を負いません。<br />
